...
- Apply obtained data to derive the moments closure models by Machine-Learning-assisted techniques.
  ...
  > [4] J. Huang, L. Liu, K. Qi and J. Wan, _Machine learning-based moment closure model for the linear Boltzmann equation with uncertainties_, **Comput. Methods Appl. Mech. Engrg**, 2026. ([Link](https://arxiv.org/abs/2412.01932)).
